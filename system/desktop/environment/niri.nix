{ pkgs, inputs, ... }:
let
  # Patch DankMaterialShell flake package
  dmsShellPatched = inputs.dms.packages.${pkgs.stdenv.hostPlatform.system}.default.overrideAttrs (oldAttrs: {
...
in
{
  ...
  # Disable Niri polkit (use DankMaterialShell polkit instead)
